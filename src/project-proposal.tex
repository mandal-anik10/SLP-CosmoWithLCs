...
{\Large \textbf{Laboratory Studies \cite{Chuang1991,Chuang1991_prl,Kibble2007} of Cosmology inspired Defect Dynamics in Liquid Crystals}}\\[5pt]
Anik Mandal$^{1,*}$ \\
...
Kibble proposed \cite{Kibble1976} that this process occurred unevenly across space, giving rise to 
...
form the theoretical basis for several models of cosmic structure formation \cite{Turok1989}.\\

Zurek extended this cosmological idea to condensed matter systems, suggesting that analogous defects 
could form in laboratory settings \cite{Zurek1985}. For example, a rapid phase transition in 
...
such as liquid crystals \cite{Gennes1993}, provide a more accessible platform. Their phase 
...
cosmic strings cross and reconnect. Additionally, we will test the KZM prediction \cite{Fowler2017} 
...
al.}\cite{Chuang1991, Chuang1991_prl} by employing 4-cyano-4′-n-pentylbiphenyl (5CB) nematic liquid 
