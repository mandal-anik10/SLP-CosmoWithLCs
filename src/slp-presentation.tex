...
\usetheme[progressbar=foot,numbering=fraction, background=dark, sectionpage=none]{metropolis}
...
\newcommand{\secondlogo}{../../tex-resource/ashoka-logo.png}

% % Override title page
% \setbeamertemplate{title page}{
%   \begin{minipage}[t][0.6\textheight][c]{\textwidth}
%     % \centering
%     \includegraphics[height=1.5cm]{../../tex-resource/ashoka-logo.png}\hfill
%     \includegraphics[height=1.5cm]{\secondlogo}
%     \vspace{2em}
...
%     \textbf{Supervisor:} \supervisorname\par
%     \textbf{Department:} \department\par
%     \vspace{2em}
%     \insertdate
%   \end{minipage}
% }
