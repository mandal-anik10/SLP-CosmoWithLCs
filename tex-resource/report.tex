...
\begin{figure}[h]
    ...
    \caption{This example figure(60V data) shows the region selected based on the criteria given below.}
...
$10\times$ magnification at $28\degree C$. A linear best-fit was applied to the log-log plots of defect length versus time, resulting in the following slopes \ref{fig:dyn_string_density}:
\begin{itemize}
\item 10V: -1.20
\item 20V: -0.80
\item 40V: -0.98
