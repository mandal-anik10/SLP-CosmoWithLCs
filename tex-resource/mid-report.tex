...
\usepackage{geometry, hyperref, amsmath, fontspec, enumitem, graphicx, subfig}
...
\begin{figure}[h]
    ...
    \subfloat[Caption for Subfigure A]{\includegraphics[width=0.35\textwidth]{figs/60V_dyn_0.png}}
    \hspace{0.05\textwidth} % Adds horizontal space between subfigures
    \subfloat[Caption for Subfigure B]{\includegraphics[width=0.35\textwidth]{figs/60V_dyn_0e.png}}

    \vspace{0.5cm} % Adds vertical space between rows

    % Second row of subfigures
    \subfloat[Caption for Subfigure C]{\includegraphics[width=0.35\textwidth]{figs/60V_dyn_50e.png}}
    \hspace{0.05\textwidth} % Adds horizontal space between subfigures
    \subfloat[Caption for Subfigure D]{\includegraphics[width=0.35\textwidth]{figs/60V_dyn_200e.png}}

    \caption{Overall caption for the 2x2 grid of figures.}
    \label{fig:2x2subfigures}
\end{figure}

\begin{figure}[h]
    \centering
    % First row of subfigures
    \subfloat[Caption for Subfigure A]{\includegraphics[width=0.45\textwidth]{figs/10V-rho_dyn.png}}
    \hspace{0.05\textwidth} % Adds horizontal space between subfigures
    \subfloat[Caption for Subfigure B]{\includegraphics[width=0.45\textwidth]{figs/20V-rho_dyn.png}}

    \vspace{0.5cm} % Adds vertical space between rows

    % Second row of subfigures
    \subfloat[Caption for Subfigure C]{\includegraphics[width=0.45\textwidth]{figs/40V-rho_dyn.png}}
    \hspace{0.05\textwidth} % Adds horizontal space between subfigures
    \subfloat[Caption for Subfigure D]{\includegraphics[width=0.45\textwidth]{figs/60V-rho_dyn.png}}
