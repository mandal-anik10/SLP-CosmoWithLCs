...
\addtobeamertemplate{footline}{}{
  \begin{tikzpicture}[remember picture,overlay]
    \node[anchor=south east, xshift=-4pt, yshift=4pt] at (current page.south east) {
       \scalebox{0.75}{\textcolor{black!75}{Anik Mandal; \insertdate}}
    };
  \end{tikzpicture}
}
...
\date{\today}
\author{\textbf{Anik Mandal} \\ SLP Guide : Prof. Pramoda Kumar \\ PhD Supervisor : Prof. Somak Raychaudhury }
\institute{Ashoka University, Sonipat}
...
\midrule
\includegraphics[valign=t, trim={3cm 2.5cm 3cm 2.5cm}, clip, scale=0.9]{figs//imported/Sym_CatApple.png} \hspace{5pt}\vrule width 2pt\hspace{5pt}\includegraphics[valign=t, trim={3cm 2.5cm 3cm 2.5cm}, clip, scale=0.9]{figs//imported/Sym_CatApple.png} &  \includegraphics[valign=t, trim={3cm 2.5cm 3cm 2.5cm}, clip, scale=0.9]{figs//imported/BrokenSym_CatApple_R.png} \hspace{5pt}\vrule width 2pt\hspace{5pt} \includegraphics[valign=t, trim={3cm 2.5cm 3cm 2.5cm}, clip, scale=0.9]{figs/imported/BrokenSym_CatApple_L.png}\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}
    \centering
    \subfloat[Symmetry Breaking (\href{https://cds.cern.ch/record/1664409/plots}{Source})]{\includegraphics[width=0.3\linewidth]{figs/imported/Sym_breaking.png}}\hspace{.1cm}
    \subfloat[Domain Walls (\href{https://www.ctc.cam.ac.uk/outreach/origins/cosmic_structures_two.php}{Source})]{\includegraphics[width=0.3\linewidth]{figs/imported/domain_wall.png}}\hspace{.1cm}
    \subfloat[String Defects (\href{https://www.ctc.cam.ac.uk/outreach/origins/cosmic_structures_two.php}{Source})]{\includegraphics[width=0.3\linewidth]{figs/imported/string_defect.png}}
\end{figure}

\begin{itemize}
    \item[$\blacktriangleright$] Defect or mismatch forms at the boundary of two causally disconnected points in space.\footcite{Kibble1976TopologyStrings}
...
\begin{itemize}
    \item[$\blacktriangleright$] In 1985, Zurek extended Kibble's idea to condensed matter physics.\footcite{Zurek1985CosmologicalHelium}$^,$\footcite{Zurek1996CosmologicalSystems}
    \item[$\blacktriangleright$] Liquid crystals adopted as a robust alternative.\footcite{Chuang1991CosmologyCrystals}$^,$\footcite{Yurke1992CoarseningCrystals}$^,$\footcite{Fowler2017KibbleZurekCrystal}
\end{itemize}
\end{frame}

\begin{frame}{Kibble-Zurek Mechanism | Project Objectives}
\begin{itemize}
    \item[$\blacktriangleright$] Kibble--Zurek scaling of defect density ($\rho$),
    \[
        \rho \propto \tau_Q^{-d\nu/(1+\nu z)},
    \]
    \begin{itemize}
        \item Critical slowing down near the transition point.
        \item system freezes at certain time and length scale.
    \end{itemize}
    
    \item[$\blacktriangleright$] Defect networks coarsen to minimize the Frank elastic free energy, 
    \[
        F=\frac{1}{2}\!\left[ K_1(\nabla\!\cdot\!\mathbf{n})^2 + K_2(\mathbf{n}\!\cdot\!\nabla\!\times\!\mathbf{n})^2 + K_3|\mathbf{n}\!\times\!\nabla\!\times\!\mathbf{n}|^2 \right],
    \]
    
    \begin{itemize}
        \item String defect (d=2) : $\rho(t)\!\propto\! t^{-1}$
        \item Domain walls (d=1) : $\rho(t)\!\propto\! t^{-1/2}$
    \end{itemize} 
\end{itemize}
...
\begin{figure}
    \centering
    \includegraphics[width=0.95\linewidth, trim = {0 0 0 16cm}, clip]{figs/imported/Freedericksz_transitionP.png}
    \caption{Fréedericksz transition due to electric field quench in homeotropically aligned LC \\(\href{https://doi.org/10.1039/B308098F}{Source})}
...
\begin{column}{0.8\textwidth}
\begin{itemize}
    \item[$\blacktriangleright$] 0.2\% DMOAP solution prepared in distilled water. Glass slabs were dipped vertically for 5 minutes.
    \item[$\blacktriangleright$] Methoxy groups hydrolyze and bind to surface hydroxyl groups.
    \item[$\blacktriangleright$] Subsequent baking at 110$^\circ$C for 60 minutes forms strong covalent siloxane (Si-O-Si) bonds, and molecules orient perpendicular to the substrate.
\end{itemize}

\begin{figure}
    \centering
    \subfloat[DMOAP (\href{https://pubchem.ncbi.nlm.nih.gov/compound/Quat-silsesquioxane}{Source})]{\includegraphics[width=0.45\linewidth]{figs/imported/DMOAP.png}}
    \subfloat[MBBA (\href{https://en.wikipedia.org/wiki/MBBA}{Source})]{\includegraphics[width=0.45\linewidth]{figs/imported/MBBA.png}}
    \label{fig:placeholder}
\end{figure}
...
\begin{itemize}
    \item[$\blacktriangleright$] DMOAP-treated slabs are sandwiched together along with $23\,\mu\mathrm{m}$ Mylar film, placed along the edges.
    \item[$\blacktriangleright$] Applied gentle pressure (30 min), then epoxy cured (24 h).
    \item[$\blacktriangleright$] Conducting wires soldered to ITO electrodes using Indium.
\end{itemize}
...
\begin{itemize}
    \item[$\blacktriangleright$] Measured capacitance ($C$) using LCR meter; modeled as parallel plates to measured cell thickness.
\end{itemize}
...
\begin{itemize}
    ...
    \item[$\blacktriangleright$] Slow cooling minimizes permanent defect formation.
\end{itemize}
...
\begin{itemize}
    \item[$\blacktriangleright$] 10-60 V RMS, 10 kHz sine wave electric field has been generated using a \textit{ function generator} and \textit{A800DI amplifier} and provided to the cell. 
\end{itemize}
\begin{columns}
    \begin{column}{0.35\textwidth}
    \begin{itemize}
    \item[$\blacktriangleright$] Data taken at $28^\circ$Cm controlled temp; $10\times$ optical magnification.
    \item[$\blacktriangleright$] Video recorded at 100 fps under polarized illumination.
    \end{itemize}
    \end{column}
...
\begin{columns}
    ...
    \caption{\footnotesize{(L) A pair of $\pm1/2$ wedge disclinations connected by a $\pi$-wall under a cross polarizer. (R) 2D director field Sketch (Source\footcite{Blanc2005DynamicsBackflow})}}.
    \label{fig:placeholder}
    \end{figure}
    \end{column}
...
\begin{columns}
    ...
    \caption{\footnotesize{Shape evolution of a single domain at different moments and the corresponding
polarizing optical microscope micrographs. (L) Early stage of  annihilation (R) Late stage of the annihilation(Source\footcite{Shen2020AnnihilationCrystals})}}.
    \label{fig:placeholder}
    \end{figure}
    \end{column}
    ...
    \begin{figure}
    \centering
    \includegraphics[width=0.95\linewidth, trim={0.5cm 0.5cm 0.5cm 0.5cm}, clip]{figs/28_new_60V_dyn.png}
    \caption{\footnotesize{Topological defects at different time stamps for 60V at 10$\times$ resolution.}}
    \label{fig:placeholder}
    \end{figure}
...
\begin{frame}{Late time dynamics: cell without permanent defects}
    ...
    \subfloat[60V : -0.33\footcite{Guimaraes2013AnnihilationCrystal}$^,$\footcite{Dierking2025MachineNanoparticles}]{\includegraphics[width=0.5\textwidth, trim={1cm 0 2cm 1cm}, clip]{figs/28_new_60V_scalling.png}}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{figs/formation_dyn-P.png}
...
\begin{frame}[fragile]{Conclusion}
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \textbf Variable $\pi$-wall widths observed, consistent with field-dependent coherence length.
        \end{itemize}
        ...
        \begin{itemize}
            ...
            \item \textit{Result: No stable intermediate regime observed for KZM scaling of defects in MBBA LC.}
        \end{itemize}
    \end{itemize}
\end{frame}
\begin{frame}{What people can learn next?}
    \begin{itemize}
        ...
        \begin{itemize}
            \item  Magnetic fields or rapid thermal quenches can be performed to access universal scaling with more suitable LCs like 5CB.
            \item  Inverse scaling of $\pi$-wall width vs. field strength can be verified.\footcite{Blanc2005DynamicsBackflow}.
            \item  A more sophisticated machine-learning-based framework can be developed to resolve complex umbilic trajectories\footcite{Dierking2025MachineNanoparticles}.
        \end{itemize}
        \item[$\blacktriangleright$] \textbf{Questions I have}
        \begin{itemize} 
            \item Suppose vacuum states have non-degenerate masses; what effect would this asymmetry have on defect dynamics in the presence of gravity? 
            \item How does the probability of quantum tunneling between vacuum states (vacuum decay) influence the stability and evolution of the defect network? 
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{tikzpicture}
    \node[
        ...
        minimum width=10cm,    % Exact width
